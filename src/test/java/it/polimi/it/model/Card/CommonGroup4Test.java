...
public class CommonGroup4Test {
    ...
    @Test
    public void checkGoalTest1(){ //testing card 8
    ...
    @Test
    public void checkGoalTest2(){ //testing card 8
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest3(){ //testing card 11
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest4(){ //testing card 11
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest5(){ //testing card 11
        Tile[][] matrix = new Tile[6][5];
        ...
        matrix[1][4] = new Tile(1,4,PossibleColors.BLUE);
        matrix[2][4] = new Tile(2,4,PossibleColors.GREEN);
        matrix[3][4] = new Tile(3, 4,PossibleColors.YELLOW);
        matrix[4][4] = new Tile(4,4,PossibleColors.PINK);
        matrix[5][4] = new Tile(5,4,PossibleColors.YELLOW);
    ...
    @Test
    public void checkGoalTest6(){ //testing card 11
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest7(){ //testing card 11
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest8(){ //testing card 11
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest9(){ //testing card 11
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest10(){ //testing card 11
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest11(){ //testing card 11
        Tile[][] matrix = new Tile[6][5];
        ...
        matrix[0][1] = new Tile(0, 1, PossibleColors.PINK);
        matrix[1][1] = new Tile(1,1,PossibleColors.WHITE);
        matrix[2][1] = new Tile(2,1,PossibleColors.CYAN);
        matrix[3][1] = new Tile(3, 1,PossibleColors.YELLOW);
        matrix[4][1] = new Tile(4,1,PossibleColors.BLUE);
        matrix[5][1] = new Tile(5,1,PossibleColors.YELLOW);
    ...
    @Test
    public void checkGoalTest12(){ //testing card 8
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest13(){ //testing card 11
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest16(){ //testing card 8
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest17(){ //testing card 11
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest18(){ //testing card 11
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest19(){ //testing card 8
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest20(){ //testing card 8
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest21(){ //testing card 8
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest22(){ //testing card 8
        Tile[][] matrix = new Tile[6][5];
