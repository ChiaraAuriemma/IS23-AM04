...
public class CommonGroup1Test {
    ...
    @Test
    public void checkGoalTest9(){ //testing card 1
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest10(){ //testing card 10
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest11(){ //testing card 10
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest12(){ //testing card 1
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest13(){ //testing card 1
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    public void checkGetID(){
        if(card1.getID() != 1 || card2.getID() != 10)
            fail("Test failed");
    }
}
