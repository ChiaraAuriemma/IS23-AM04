...
public class CommonGroup5Test {
    ...
    @Test
    public void checkGoalTest4(){ //testing card 9
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest5(){ //testing card 9
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest6(){ //testing card 9
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest7(){ //testing card 9
        Tile[][] matrix = new Tile[6][5];
