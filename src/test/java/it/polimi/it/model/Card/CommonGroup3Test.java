...
public class CommonGroup3Test {
    ...
    @Test
    public void checkGoalTest1(){ //testing card 3
        Tile[][] matrix = new Tile[6][5];

        matrix[0][0] = new Tile(0, 0, PossibleColors.CYAN);
        ...
        matrix[5][0] = new Tile(5,0,PossibleColors.BLUE);
    ...
    @Test
    public void checkGoalTest2(){ //testing card 3
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest3(){ //testing card 3
        Tile[][] matrix = new Tile[6][5];
        ...
        matrix[4][0] = new Tile(4,0,PossibleColors.YELLOW);
        ...
        matrix[3][1] = new Tile(3, 1,PossibleColors.GREEN);
        ...
        matrix[1][2] = new Tile(1,2,PossibleColors.GREEN);
        matrix[2][2] = new Tile(2,2,PossibleColors.GREEN);
        ...
        matrix[0][3] = new Tile(0, 3, PossibleColors.GREEN);
        matrix[1][3] = new Tile(1,3,PossibleColors.GREEN);
        ...
        matrix[5][3] = new Tile(5,3,PossibleColors.WHITE);
    ...
    @Test
    public void checkGoalTest4(){ //testing card 3
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest5(){ //testing card 3
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest6(){ //testing card 4
        Tile[][] matrix = new Tile[6][5];

        matrix[0][0] = new Tile(0, 0, PossibleColors.WHITE);
        matrix[1][0] = new Tile(1,0,PossibleColors.PINK);
        ...
        matrix[0][1] = new Tile(0, 1, PossibleColors.WHITE);
        ...
        matrix[1][3] = new Tile(1,3,PossibleColors.YELLOW);
        matrix[2][3] = new Tile(2,3,PossibleColors.YELLOW);
        matrix[3][3] = new Tile(3, 3,PossibleColors.PINK);
        matrix[4][3] = new Tile(4,3,PossibleColors.CYAN);
        matrix[5][3] = new Tile(5,3,PossibleColors.GREEN);

        matrix[0][4] = new Tile(0, 4, PossibleColors.CYAN);
    ...
    @Test
    public void checkGoalTest7(){ //testing card 4
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest8(){ //testing card 4
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest9(){ //testing card 4
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest10(){ //testing card 4
        Tile[][] matrix = new Tile[6][5];
        ...
        matrix[0][4] = new Tile(0, 4, PossibleColors.BLUE);
        matrix[1][4] = new Tile(1,4,PossibleColors.PINK);
        matrix[2][4] = new Tile(2,4,PossibleColors.GREEN);
        matrix[3][4] = new Tile(3, 4,PossibleColors.YELLOW);
        matrix[4][4] = new Tile(4,4,PossibleColors.PINK);
        matrix[5][4] = new Tile(5,4,PossibleColors.WHITE);
    ...
    @Test
    public void checkGoalTest11(){ //testing card 4
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest12(){ //testing card 3
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest13(){ //testing card 3
        int column, row;
        Tile[][] matrix = new Tile[6][5];
        ...
        matrix[0][2] = new Tile(0, 2, PossibleColors.WHITE);
        matrix[1][2] = new Tile(1,2,PossibleColors.BLUE);
        matrix[2][2] = new Tile(2,2,PossibleColors.BLUE);
        matrix[3][2] = new Tile(3, 2,PossibleColors.DEFAULT);
        matrix[4][2] = new Tile(4,2,PossibleColors.DEFAULT);
        matrix[5][2] = new Tile(5,2,PossibleColors.DEFAULT);
    ...
    @Test
    public void checkGoalTest14(){ //testing card 3
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest15(){ //testing card 4
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest16(){ //testing card 4
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest17(){ //testing card 4
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest18(){ //testing card 3
        Tile[][] matrix = new Tile[6][5];
        ...
        matrix[0][2] = new Tile(0, 2, PossibleColors.BLUE);
        matrix[1][2] = new Tile(1,2,PossibleColors.BLUE);
        matrix[2][2] = new Tile(2,2,PossibleColors.DEFAULT);
        matrix[3][2] = new Tile(3, 2,PossibleColors.DEFAULT);
        matrix[4][2] = new Tile(4,2,PossibleColors.DEFAULT);
    ...
    @Test
    public void checkGoalTest19(){ //testing card 3
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest21(){ //testing card 4
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest22(){ //testing card 4
        int column, row;
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest23(){ //testing card 3
        Tile[][] matrix = new Tile[6][5];
    ...
    @Test
    public void checkGoalTest24(){ //testing card 3
        Tile[][] matrix = new Tile[6][5];
