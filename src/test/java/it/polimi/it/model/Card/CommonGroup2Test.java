...
public class CommonGroup2Test {
    ...
    public void checkGoalTest2(){ //testing card 2
        ...
        matrix[0][0] = new Tile(5, 0, PossibleColors.PINK);
        matrix[1][0] = new Tile(0, 2,PossibleColors.CYAN);
        matrix[2][0] = new Tile(2, 1,PossibleColors.YELLOW);
        matrix[3][0] = new Tile(5, 2,PossibleColors.BLUE);
        matrix[4][0] = new Tile(3, 3,PossibleColors.WHITE);
        matrix[5][0] = new Tile(4, 4,PossibleColors.GREEN);

        matrix[0][1] = new Tile(5, 0, PossibleColors.CYAN);
        matrix[1][1] = new Tile(0, 2,PossibleColors.PINK);
        matrix[2][1] = new Tile(2, 1,PossibleColors.YELLOW);
        matrix[3][1] = new Tile(5, 2,PossibleColors.WHITE);
        matrix[4][1] = new Tile(3, 3,PossibleColors.BLUE);
        matrix[5][1] = new Tile(4, 4,PossibleColors.GREEN);
    ...
    @Test
    public void checkGoalTest5(){ //testing card 6
        int column, row;
        Tile[][] matrix = new Tile[6][5];
        for(column=0; column<5; column++){
            for (row=0; row<6; row++){
        ...
        matrix[1][0] = new Tile(0, 0, PossibleColors.PINK);
        matrix[1][1] = new Tile(1, 0,PossibleColors.CYAN);
        matrix[1][2] = new Tile(2, 0,PossibleColors.YELLOW);
        matrix[1][3] = new Tile(3, 0,PossibleColors.BLUE);
        matrix[1][4] = new Tile(4, 0,PossibleColors.WHITE);
        matrix[1][0] = new Tile(5, 0,PossibleColors.GREEN);
