...
public class PersonalGoalCard9 extends PersonalGoalCard{
    ...
    public PersonalGoalCard9(){
        ...
        this.Score.put(PossibleColors.BLUE,Position0);
        this.Position1.add(0,1);
        this.Position1.add(1,1);
        this.Score.put(PossibleColors.CYAN,Position1);
        ...
        this.Score.put(PossibleColors.YELLOW,Position3);
        this.Position4.add(0,4);
        this.Position4.add(1,1);
